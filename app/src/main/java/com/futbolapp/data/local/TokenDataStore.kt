...
package com.futbolapp.data.local
...
private val Context.dataStore: DataStore<Preferences>
        by preferencesDataStore(name = "futbol_session")
...
class TokenDataStore @Inject constructor(
    ...
    companion object {
        ...
        val KEY_TIPO_USUARIO = stringPreferencesKey("tipo_usuario")
        val KEY_IDIOMA       = stringPreferencesKey("idioma")
    }
    ...
    suspend fun saveUser(
        ...
        context.dataStore.edit { prefs ->
            ...
            prefs[KEY_TIPO_USUARIO] = tipoUsuario
            prefs[KEY_IDIOMA]       = idioma
        }
    }
    ...
    val userSnapshot: Flow<UserSnapshot?> = context.dataStore.data.map { prefs ->
        ...
        UserSnapshot(
            ...
            tipoUsuario = prefs[KEY_TIPO_USUARIO] ?: "",
            idioma      = prefs[KEY_IDIOMA]       ?: "",
        )
    }
}